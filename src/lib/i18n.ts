  ...
  fr: {
    translation: {
      ...
      vehicules: {
        ...
        selectCategorieFirst: "Choisir une catégorie",
        noGenre: "Aucun genre disponible",
  ...
  en: {
    translation: {
      ...
      vehicules: {
        ...
        places: "Seats",
        typeVehicule: "Subtype",
        client: "Client",
        selectClient: "— Select a client —",
        selectGenre: "— Select a subtype —",
        selectCategorieFirst: "Choose a category",
        noGenre: "No subtype available",

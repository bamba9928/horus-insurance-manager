/**
 * Routes profil utilisateur : lecture des informations du compte et changement
...
import { findUserById, recordSecurityEvent, updateUserPassword } from "../db/adminDb.js";
...
export function profileRoutes(ctx: AppContext): Hono<AuthEnv> {
  ...
  app.patch("/", (c) => {
    return c.json({ error: "Seul l'administrateur peut modifier les informations du compte" }, 403);
  });

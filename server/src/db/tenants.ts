 ...
 * créé depuis le même schéma que l'application desktop, avec les migrations
 * complémentaires serveur pour les catégories véhicule et les durées police.
 *
...
INSERT OR IGNORE INTO _migrations (name) VALUES ('004_durees_police_1_12');
`,
  },
];

/** Migrations qui reconstruisent une table : foreign_keys doit être OFF autour. */
const FK_OFF_MIGRATIONS = new Set(["003_genre_categories", "004_durees_police_1_12"]);
